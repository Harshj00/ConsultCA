            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="mt-5 flex flex-col sm:flex-row gap-2 justify-center md:justify-start">
                  <a
                    href="https://www.linkedin.com/in/harshgod"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary text-primary-foreground px-4 py-2.5 text-sm font-medium transition-base hover:bg-primary/90 shadow-soft"
                  >
                    <Linkedin className="h-4 w-4" />
                    Connect on LinkedIn
                  </a>
                  <a
                    href="https://harshjha08.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground transition-base hover:border-accent/40 hover:bg-accent-soft hover:text-accent"
                  >
